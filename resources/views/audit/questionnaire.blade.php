...
<body>
    {{-- Judul mengikuti klausul yang sedang dibuka --}}
    <h2>Audit {{ $clause }} – {{ $clauseTitle ?? 'Section Details' }}</h2>
    
    {{-- Form action otomatis mengarah ke klausul yang sedang aktif --}}
    <form method="POST" action="/audit/{{ $auditId }}/{{ $clause }}" id="form">
        @csrf
        ...
        <div class="question-box">
            <h4>Catatan / Pertanyaan Auditor (Klausul {{ $clause }})</h4>
            <p style="font-size: 13px; color: #666; margin-bottom: 10px;">
                Jika ada temuan atau catatan khusus untuk klausul ini, silakan tulis di bawah:
            </p>
            <textarea 
                name="audit_question" 
                rows="4" 
    ...
    <div class="modal" id="modal">
        <div class="modal-box">
            <div class="modal-header">
                <h4>Jawaban Audit - Item <span id="modal_item_id_display"></span></h4>
