...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Standards & Scope - TANPA FITUR SEARCHABLE
    new TomSelect('#select-standards', { 
        plugins: ['remove_button'],
        maxItems: null,
        placeholder: 'Pilih standar yang relevan...',
        dropdownInput: false, // ← SEMBUNYIKAN INPUT PENCARIAN
        hidePlaceholder: true // ← SEMBUNYIKAN PLACEHOLDER DI DROPDOWN
    });
    ...
    // Lead Auditor (HANYA INI YANG PAKAI SEARCHABLE - untuk memudahkan pencarian)
    ...
    // Departemen Auditee - TANPA FITUR SEARCHABLE
