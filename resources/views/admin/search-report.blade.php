...
<div class="max-w-2xl mx-auto mt-10">
    <div class="bg-white rounded-xl shadow-md p-6 border border-gray-200">
        <h2 class="text-lg font-bold text-blue-700 mb-4">🔍 Cari Laporan Cepat</h2>
        <p class="text-sm text-gray-600 mb-6">Masukkan ID laporan (UUID) untuk langsung membuka detail audit.</p>
