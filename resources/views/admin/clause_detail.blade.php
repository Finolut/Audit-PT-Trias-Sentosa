...
{{-- HEADER & NAVIGATION --}}
{{-- 
  1. -mx-4 sm:-mx-6 lg:-mx-8 : Menarik header agar full ke samping kiri-kanan (menabrak padding layout)
...
{{-- Hilangkan div h-28 spacer karena kita tidak pakai fixed lagi --}}
