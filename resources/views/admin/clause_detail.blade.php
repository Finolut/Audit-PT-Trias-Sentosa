...
@section('content')
    <div class="flex h-screen bg-white">
        ...
        {{-- SIDEBAR KIRI --}} 
        <div class="fixed left-0 top-0 h-full w-16 bg-white border-r border-gray-200 flex flex-col items-center pt-4 pb-8 space-y-6 z-40">
            <a href="#" class="w-10 h-10 bg-blue-600 rounded-lg flex items-center justify-center text-white font-bold text-xl">
                TS
            </a>

            <div class="space-y-4 w-full px-2">
                <a href="#" class="block w-full p-2 rounded-md bg-blue-50 text-blue-700 hover:bg-blue-100 transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9M9 9l2 2 2-2m-2 2v10" />
                    </svg>
                </a>

                <a href="#" class="block w-full p-2 rounded-md text-gray-600 hover:bg-gray-100 transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 7h6m0 10v-6M9 17h6" />
                    </svg>
                </a>
        ...
        {{-- MAIN CONTENT AREA --}}
        <div class="ml-16 flex-1 flex flex-col overflow-hidden">
