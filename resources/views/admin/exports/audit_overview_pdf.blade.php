...
<body>
    ...
    <div class="audit-overview">
        ...
        <table class="audit-info-grid" style="width: 100%;">
            <tr>
                <td style="width: 120px; vertical-align: top; padding-bottom: 5px;"><strong>Kode Audit</strong></td>
                <td style="width: 300px; vertical-align: top; padding-bottom: 5px;">: {{ $audit->audit_code ?? $audit->id }}</td>
            ...
            <tr>
                <td style="vertical-align: top; padding-bottom: 5px;"><strong>Departemen</strong></td>
                <td style="vertical-align: top; padding-bottom: 5px;">: {{ $audit->department->name ?? '-' }}</td>
